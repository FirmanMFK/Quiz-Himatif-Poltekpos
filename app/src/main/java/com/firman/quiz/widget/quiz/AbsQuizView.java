...
import com.firman.quiz.activity.QuizActivity;
import com.firman.quiz.helper.ViewUtils;
import com.firman.quiz.model.Category;
import com.firman.quiz.model.quiz.Quiz;
import com.firman.quiz.widget.fab.CheckableFab;

/**
 * This is the base class for displaying a {@link com.firman.quiz.model.quiz.Quiz}.
 * <p>
 ...
 * </p>
 *
 * @param <Q> The type of {@link com.firman.quiz.model.quiz.Quiz} you want to
 * display.
 */
public abstract class AbsQuizView<Q extends Quiz> extends FrameLayout {
    ...
    public static final Property<FrameLayout, Integer> FOREGROUND_COLOR =
            new ViewUtils.IntProperty<FrameLayout>("foregroundColor") {
